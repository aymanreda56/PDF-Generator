...
number_officers = helpers.getNumOfficers()
present_officers = 1
absent_officers = 0

number_caps = helpers.getNumCaps()
present_caps = 0
absent_caps = 1

number_soldiers = helpers.getNumSoldiers()
present_soldiers = 7
absent_soldiers = 8
...
def Export_Tamam_PDF():
    ...
    Replace_Placeholders_Inside_Document(doccc, fields_to_replace=fields_to_replace)
